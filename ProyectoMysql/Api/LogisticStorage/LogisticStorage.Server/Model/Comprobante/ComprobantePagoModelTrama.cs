...
{
    public class ComprobantePagoModelTrama
    {

        public ComprobantePagoModelTrama(ComprobantePagoEntity Item)
        {


            m_Serie = Item.Correlativo;




        }
        public String m_Serie { get; set; } = "";
