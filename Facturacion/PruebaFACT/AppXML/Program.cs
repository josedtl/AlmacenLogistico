...
namespace AppXML
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            ComprobantePagoEntity Item_CP_Cabecera = new ComprobantePagoEntity();
            ...
            List<ComprobantePagoDetalleEntity> Detalle = new List<ComprobantePagoDetalleEntity>();


            /////////////1 Detalle  DETALLE DE PRODUCTO


            ComprobantePagoDetalleEntity Item1 = new ComprobantePagoDetalleEntity();
            ...
            ComprobantePagoDetalleEntity Item2 = new ComprobantePagoDetalleEntity();
        ...
        public static InvoiceLine AgregarDetalleXML(ComprobantePagoEntity Item_CP_Cabecera, ComprobantePagoDetalleEntity _detalle)
        {
