...
namespace FactCoreApi.Controllers
{
    ...
    public class EntListaController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("Registrar")]
        public ResponseAPI<EntListaItemModel> Registrar(EntListaItemModel Item)
        {
            try
            {
                d.Configurar();
                ...
                return new ResponseAPI<EntListaItemModel>(Item, true);
            }
            catch (Exception ex)
            {
                return new ResponseAPI<EntListaItemModel>(new EntListaItemModel(), false, ex.Message);
            }
        }
