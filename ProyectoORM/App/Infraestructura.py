...
try:
    with conexion.cursor() as cursor:
        ...
        url = "http://localhost/ServiceSpace/api/Infraestructura/Registrar"
        ...
        for fila in resultados:
            data = {
                ...
                "Estado": 1,
                "CodigoSistema": fila["CodigoSistema"],
                "CodigoInterno": fila["CodigoInterno"],
                "Descripcion": fila["Descripcion"],
                "TipoInfraestructuraId": fila["TipoInfraestructuraId"],
                "InfraestructuraDimensionId": fila["InfraestructuraDimensionId"],
                "Aforo": fila["Aforo"],
                "PisoId": fila["PisoId"],
